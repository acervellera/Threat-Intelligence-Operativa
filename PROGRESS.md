...
Aggiornare questo file soltanto quando esiste un'evidenza verificabile.

| ID | Fase | Stato | Evidence / PR | Data UTC |
|---|---|---|---|---|
| STEP-00 | Governance e publication gate | IN PROGRESS | - | - |
| STEP-01 | Metodo analitico A/B/C | NOT STARTED | - | - |
| STEP-02 | Rete e VM | NOT STARTED | - | - |
...
- `VALIDATED` richiede test positivo, test negativo e cleanup.
- `SANITIZED` richiede publication checklist firmata nel pull request.
- `PUBLISHED` richiede evidenze pubbliche, hash, fonti e limiti dichiarati.
